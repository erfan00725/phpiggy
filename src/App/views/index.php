                ...
                <tr>
                    ...
                    <td class="p-4 text-sm text-gray-600">
                        <?php foreach($transaction['receipts'] as $receipt) : ?>
                            ...
                            <form action="/transaction/<?php echo $transaction['id']; ?>/receipt/<?php echo $receipt['id']; ?>" method="POST">
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="hidden md:-mt-px md:flex">
            <?php foreach ($pageLinks as $page => $query) : ?>
                <a href="/?<?php echo e($query); ?>" class="<?php echo $currentPage === $page + 1 ? "border-indigo-500 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" ?>inline-flex items-center border-t-2 px-4 pt-4 text-sm font-medium">
                    <?php echo e($page + 1); ?>
                </a>
            <?php endforeach; ?>
